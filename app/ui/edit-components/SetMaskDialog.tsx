  ...
  <Dialog
   ...
   PaperProps={{
    sx: {
     ...
     borderRadius: 1,
      // ================= FIX START =================
      // 移除了 `background: 'white'`，让背景色由主题控制。
      // 使用 `bgcolor` 属性并从主题中获取背景色，这是 MUI 的推荐做法。
  ...
  >
   <IconButton
    ...
    sx={{
     ...
     top: 8,
      // ================= FIX START =================
      // 将颜色设置为 'text.primary'，它会根据主题自动变为黑色或白色。
     color: 'text.primary',
      // ================= FIX END ===================
    }}
   >
     ...
     <Box sx={{ width: '100%', minWidth: 450, maxWidth: 600, pr: 5 }}>
      <Typography
       sx={{
        fontSize: '1.7rem',
          // ================= FIX START =================
          // 将颜色设置为 'text.primary'，这是主要文本的推荐颜色
        color: 'text.primary',
          // ================= FIX END ===================
        fontWeight: 400,
        display: 'flex',
      ...
      <Typography
       sx={{
        fontSize: '1.1rem',
          // ================= FIX START =================
          // 将颜色设置为 'text.secondary'，这是次要文本的推荐颜色
        color: 'text.secondary',
          // ================= FIX END ===================
        fontWeight: 400,
        display: 'flex',
