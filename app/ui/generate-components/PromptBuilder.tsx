...
export default function PromptBuilder({ onApply, onClose }: {
  ...
  const currentUseCase: UseCaseTemplate | undefined = useMemo(() => {
    return veoTemplates[selectedIndustry as keyof typeof veoTemplates]?.useCases[selectedUseCase as keyof typeof veoTemplates[keyof typeof veoTemplates]['useCases']];
